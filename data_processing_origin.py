...
def geoJson_to_tif(filename):
    ...
    dirtif = "/mnt/hdd/Datasets/AOI_5_Khartoum_Train/RGB-PanSharpen/"

    # Location of polygon files in .geojson format
    dirgjson = "/mnt/hdd/Datasets/AOI_5_Khartoum_Train/geojson/buildings/"

    # Location of the place which created masks will held place.
    dirmasktif = "/mnt/hdd/Datasets/AOI_5_Khartoum_Train/masktif/"
...
for filename in os.listdir(
        "/mnt/hdd/Datasets/AOI_5_Khartoum_Train/geojson/buildings/"):
